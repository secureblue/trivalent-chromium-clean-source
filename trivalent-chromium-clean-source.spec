...
rm -rf ./src/third_party/jdk/current ./src/third_party/blink/web_tests ./src/third_party/catapult/tracing/test_data \ 
       ./src/third_party/depot_tools ./src/buildtools/reclient ./src/third_party/instrumented_libs
